...
# Edges.
pgm.add_edge( "w_1",    "x_1" )
pgm.add_edge( "w_2",    "x_2" )
pgm.add_edge( "w_3",    "x_3" )
pgm.add_edge( "w_4",    "x_4" )
pgm.add_edge( "w_5",    "x_5" )
pgm.add_edge( "w_6",    "x_6" )
pgm.add_edge( "w_7",    "x_7" )
pgm.add_edge( "w_8",    "x_8" )
pgm.add_edge( "w_9",    "x_9" )
pgm.add_edge( "w_10",   "x_10")
pgm.add_edge( "w_11",   "x_11")
pgm.add_edge( "w_12",   "x_12")
...
# Render and save.
pgm.render()
pgm.savefig( "grid_generative.pdf" )
pgm.savefig( "grid_generative.png", dpi = 400 )
